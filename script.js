...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!dashBtn) {
        ...
        dashBtn.onclick = function() {
            window.open(dashboardUrl, '_blank');z            // Responsive nav menu toggle
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Edit Mode toggle for media buttons
                const editBtn = document.getElementById('edit-toggle');
                const mediaBtns = document.getElementById('media-btns');
                if (editBtn && mediaBtns) {
                    editBtn.addEventListener('click', function() {
                        mediaBtns.style.display = mediaBtns.style.display === 'flex' ? 'none' : 'flex';
                    });
